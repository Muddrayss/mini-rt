...
#    Updated: 2024/04/23 19:03:40 by craimond         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS = $(addprefix srcs/, minirt.c init.c init2.c exit.c parse.c parse2.c parse3.c setup_scene.c setup_scene2.c setup_scene3.c setup_scene4.c setup_scene5.c render.c render_light.c render_uv_maps.c render_utils.c render_utils2.c intersections.c vector_operations.c vector_operations2.c vector_operations3.c $(UTILS))
