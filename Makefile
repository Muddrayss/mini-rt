...
#    Updated: 2024/04/23 19:12:07 by craimond         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS = $(addprefix srcs/, minirt.c init.c init2.c exit.c parse.c parse2.c parse3.c parse4.c setup_scene.c render.c render_light.c render_uv_maps.c render_utils.c render_utils2.c intersections.c intersections2.c vector_operations.c vector_operations2.c vector_operations3.c $(UTILS))
